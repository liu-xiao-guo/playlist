...
UBUNTU_TRANSLATION_DOMAIN="playlist.liu-xiao-guo"
...
aptest.commands = bash $$PWD/playlist/tests/autopilot/run
aptest.depends  = sub-playlist

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/playlist/tests/unit 
unittest.depends  = sub-playlist
